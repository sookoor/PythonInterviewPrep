...
def newPrintTask(num_students):
    seconds_per_hour = 60 * 60 # mins/hr * sec/min
    avg_num_tasks_per_hour = 2 * num_students
    seconds_per_task = seconds_per_hour / avg_num_tasks_per_hour
